...
def process_question(question: str, vector_db: Chroma) -> str:
    ...
    QUERY_PROMPT = PromptTemplate(
        ...
        template="""You are an AI language model assistant. Your task is to generate another
        different version of the given user question to retrieve relevant documents from
